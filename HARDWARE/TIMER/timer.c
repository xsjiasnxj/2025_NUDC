...
//	
//	NVIC_InitTypeDef NVIC_InitStructure;	
//	NVIC_InitStructure.NVIC_IRQChannel=TIM4_IRQn; 					//定时器 1 中断
//	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority=0x00; //抢占优先级 1
//	NVIC_InitStructure.NVIC_IRQChannelSubPriority=0x00; 		//响应优先级 3
//	NVIC_InitStructure.NVIC_IRQChannelCmd=ENABLE;
//	NVIC_Init(&NVIC_InitStructure);
//	
//	
...
void TIM1_Mode_Config()	
{
   ...
   TIM_OCInitStructure.TIM_OCNPolarity = TIM_OCPolarity_High;   	//互补输出
   ...
   TIM1_BDTRInitStructure.TIM_DeadTime = 20;              //设置死区时间
