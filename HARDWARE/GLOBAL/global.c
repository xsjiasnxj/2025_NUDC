...
pointpassfiltertype ppf0;
pointpassfiltertype ppf1;
pointpassfiltertype ppf2;
pointpassfiltertype ppf3;
//输出参数
...
float input_voltage_omega=0;
float input_voltage_theta=0;
//有效值测量变量
...
//滤波变量
pointpassfiltertype ppf_vi;
pointpassfiltertype ppf_ii1;
pointpassfiltertype ppf_ii2;
